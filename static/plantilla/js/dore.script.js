...
$.dore = function (element, options) {
  ...
  function init() {
    ...
    if (typeof Chart !== "undefined") {
      ...
      if (document.getElementById("productChart")) {
        ...
        var myChart = new Chart(productChart, {
          ...
          data: {
            labels: ["Taza Magica", "Playera", "Vinil", "Gorras", "Mason Jar"],
            datasets: [
              {
                label: "Productos",
                borderColor: themeColor1,
                backgroundColor: themeColor1_10,
                data: [456, 479, 324, 569, 340],
                borderWidth: 2
              },
              /*{
                label: "Playera",
    ...
    if (typeof Countdown !== "undefined") {
      var dateToCount = new Date(new Date("Jun 30, 2023 08:00:00").getTime());
      var countdown = new Countdown({
        selector: '#timer',
        leadingZeros: true,
        msgBefore: "Esperalo pronto",
        msgAfter: "La espera termino",
