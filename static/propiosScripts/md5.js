function md5cycle(f, h) {
    ...
    (i = ff(i, n, r, g, h[0], 7, -680876936)),
        ...
        (i = gg(i, (n = ff(n, r, g, i, h[15], 22, 1236535329)), r, g, h[1], 5, -165796510)),
        ...
        (i = hh(i, (n = gg(n, r, g, i, h[12], 20, -1926607734)), r, g, h[5], 4, -378558)),
        ...
        (i = ii(i, (n = hh(n, r, g, i, h[2], 23, -995338651)), r, g, h[0], 6, -198630844)),
...
function md51(f) {
    ...
    if (((r[h >> 2] |= 128 << (h % 4 << 3)), h > 55)) for (md5cycle(n, r), h = 0; h < 16; h++) r[h] = 0;
