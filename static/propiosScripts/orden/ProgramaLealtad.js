...
function addProgram(formbody){
    $.ajax({
        url: base_url() + "app/quicky/ProgramaLealtad/registrarPrograma",
        dataType: "JSON",
        type: "POST",
        data: formbody
    })
...
function mostrarProgramas(){
    ...
    $.ajax({
        url: base_url() + "app/quicky/ProgramaLealtad/getProgramas",
        dataType: "JSON",
        type: "GET",
...
const eliminarPrograma = async(idControl, nombreControl,Orden)=>{
    if(Orden == 1){
        ...
        $("#btnBorrarPrograma").click((e)=>{
            ...
            $.ajax({
                url: base_url() + "app/quicky/ProgramaLealtad/borrarPrograma",
                dataType: "JSON",
                type: "POST",
                data: formbody
            })
...
const editarPrograma = async(idControl)=>{
  ...
  await $.ajax({
        url: base_url() + "app/quicky/ProgramaLealtad/consultarPrograma",
        dataType: "JSON",
        type: "POST",
        data: formbody
    })
...
const execUpdateprograma = async (formbody) => {
    ...
    $.ajax({
        url: base_url() + "app/quicky/ProgramaLealtad/updatePrograma",
        dataType: "JSON",
        type: "POST",
        data: formbody
    })
...
function cambiaEstatus(idControl, estatus){
    ...
    // }
    // $.ajax({
    //     url: base_url() + "app/quicky/ProgramaLealtad/habilitarPrograma",
    //     dataType: "JSON",
    //     type: "POST",
    //     data: formbody
    // })
