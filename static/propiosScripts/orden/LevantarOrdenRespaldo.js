...
const levantarOrden = () => {
    ...
    $.ajax({
        url: base_url() + "app/quicky/LevantarOrden/ListaOrdenesLE",
        dataType: "JSON",
        type: "GET",
    })
    .done((data) => {
...
function listaServiciosNoImpresos(){
    ...
    axios(base_url()+"app/quicky/LevantarOrden/verServiciosNoImpresos")
    .then(({data})=>{
...
function listaServicios(){
    ...
    axios(base_url()+"app/quicky/LevantarOrden/verServicios")
    .then(({data})=>{
...
function tiposPagos(){
    ...
    $.ajax({
        url: base_url() + "app/quicky/LevantarOrden/TiposPagos",
        dataType: "JSON",
        type: "GET",
    })
    .done((data)=>{
...
function infoCliente(){
    ...
    $.ajax({
        url: base_url() + "app/quicky/LevantarOrden/getUser",
        dataType: "JSON",
        type: "POST",
        data: {
            idU:  User
          ...
          $("#btnRealizarVenta").attr("disabled", "disabled");
           ...
           let formbody = {
            ...
            console.log("Formbody",JSON.stringify(formbody))
             ...
             $.ajax({
                url: base_url() + "app/quicky/LevantarOrden/OrdenCompra",
                dataType: "JSON",
                type: "POST",
                data: formbody,
            })
...
const LevantarOrden = () => {
    ...
    $("#selectServicios").html("");
        ...
        $.ajax({
            "url":base_url()+"app/quicky/LevantarOrden/listaServicios",
            "dataType":"JSON"
        })
        .done((data)=>{
...
function verificaUsuario(){
  $("#selectSucursal").empty();
        ...
        $.ajax({
            url: base_url() + "app/quicky/LevantarOrden/VerificaUsuario",
            dataType: "JSON",
            type: "GET",
...
function registrarUsuario(){
    ...
    if (goValidation) {
        ...
        $.ajax({
            url: base_url() + "app/quicky/LevantarOrden/registrarNuevoCliente",
            dataType: "JSON",
            type: "POST",
            data: formbody,
        })
...
function consultarSuc(idServ, nombre){
    ...
    $.ajax({
        url: base_url() + "app/quicky/LevantarOrden/consultarProducto",
        dataType: "JSON",
        type: "POST",
        data: {
            idS:  idServ
...
function AgregarCambio(){
    ...
    $("#btnverificarAcceso").off("click").on("click", (e) => {
        ...
        $("#errorAcceso").hide()        
             ...
             $.ajax({
                url: base_url() + "app/quicky/LevantarOrden/Acceder",
                dataType: "JSON",
                type: "POST",
                data: formbody,
            })
   ...
   $.ajax({
    url: base_url() + "app/quicky/LevantarOrden/getTM",
    dataType: "JSON",
    type: "GET"
    })
    .done((data)=>{
...
function añadirCambio(){
    ...
    if(bandera){
        ...
        console.log("cambioFinal", cambioFinal);
            $.ajax({
                url: base_url() + "app/quicky/LevantarOrden/CambioCaja",
                dataType: "JSON",
                type: "POST",
                data: {
...
/**
 * 2023/07/24
 * quicky Cruz, implementar programa lealtad
 */
...
const obtenerPuntos = async(cliente)=>{
    ...
    await $.ajax({
            url: base_url() + "app/quicky/ProgramaLealtad/obtenerPuntos",
            dataType: "JSON",
            type: "POST",
            data:{
                "cliente":cliente
                ...
                if(data.puntosCliente != null){
                    ...
                    // console.log("puntosStart", puntosStart)
                     $("#cantidadCliente").html(
                        `
                        <img src="https://localhost/quicky_coffee/static/img/rewards/rewards.png" alt="Imagen de recompensas" width="150" height="50">
