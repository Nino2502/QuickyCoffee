$(document).ready(() => {
    ...
    $("#btnAgregarServicio").click((e)=>{
		...
		if(validaSeleccionServicio == true){
			...
			$.ajax({
			"url": base_url()+"app/quicky/Cotizaciones/verServicio",
			"dataType":"JSON",
			"type":"POST",
			"data":{
				"id":idServicio
...
function listaServicios(){
    ...
    axios(base_url()+"app/quicky/Cotizaciones/verServicios")
    .then(({data})=>{
    ...
    $("#btnCotizacion").off("click").on("click", (e) => {
        e.preventDefault();
           ...
           // $("#btnRealizarVenta").attr("disabled", "disabled"); 
            ...
            $.ajax({
                url: base_url() + "app/quicky/Cotizaciones/registrarCotizacion",
                dataType: "JSON",
                type: "POST",
                data: formbody,
            })
...
function verificaUsuario(){
  $("#selectSucursal").empty();
        ...
        $.ajax({
            url: base_url() + "app/quicky/Cotizaciones/VerificaUsuario",
            dataType: "JSON",
            type: "GET",
...
function consultarSuc(idServ, nombre){
    ...
    $.ajax({
        url: base_url() + "app/quicky/Cotizaciones/consultarProducto",
        dataType: "JSON",
        type: "POST",
        data: {
            idS:  idServ
