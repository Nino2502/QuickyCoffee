...
class EditarPerfil extends CI_Controller{
    ...
    public function __construct(){
		...
		verifica_token();
        $this->load ->model('app/Editar_perfil_model');
    ...
    public function index(){
        ...
        $data['modals'][]  = $this->load->view('private/fragments/EditarPerfil/modalEditarPerfil', $data, TRUE);
        $data['_APP_FRAGMENT'] = $this->load->view('private/fragments/EditarPerfil/EditarPerfil_view', $data, TRUE);
    ...
    public function verTiposDePago(){
           ...
           $rs = $this->Editar_perfil_model->ver_Editar_perfil();
    ...
    public function insertaEditarPerfil(){
        ...
        if($data['accion']== "Agregar"){
            ...
            unset($data['accion']); 
            $rs = $this->Editar_perfil_model->inserta_Editar_perfil($data);

        }else if($data['accion']== "editar"){

            unset($data['accion']); 
            $rs = $this->Editar_perfil_model->update_Editar_perfil($data, $data['idFP']);
        }
    ...
    public function cambioEstatus(){
        ...
        $rs = $this->Editar_perfil_model->estatus_Editar_perfil($id);
    ...
    public function bajaLogica(){
        ...
        $id = $this->input->post("id");
        $rs = $this->Editar_perfil_model->borradoLogico($id);
