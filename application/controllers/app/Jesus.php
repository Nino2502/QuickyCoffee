...
class Jesus extends CI_Controller{
    ...
    public function __construct(){
		...
		verifica_token();
        $this->load ->model('app/Jesus_model');
    ...
    public function index(){
        ...
        $data['_APP_BREADCRUMBS']        = array("Jesus");
        $data['scripts'][] = 'propiosScripts/Jesus';
    ...
    public function verJesus(){

           $rs = $this->Jesus_model->ver_Jesus();
    ...
    public function insertaJesus(){
        ...
        if($data['accion']== "Agregar"){
            ...
            unset($data['accion']); 
            $rs = $this->Jesus_model->inserta_Jesus($data);

        }else if($data['accion']== "editar"){

            unset($data['accion']); 
            $rs = $this->Jesus_model->update_Jesus($data, $data['idjesus']);
        }
    ...
    public function cambioEstatus(){
        ...
        $rs = $this->Jesus_model->estatus_Jesus($id);
    ...
    public function bajaLogica(){
        ...
        $id = $this->input->post("id");
        $rs = $this->Jesus_model->borradoLogico($id);
