    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="nombreModal">Agregar Ingrediente</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12">
                        ...
                        <input type="text" class="form-control" id="cantidad_ingrediente" placeholder="Cantidad de ingredientes">
                        <small class="text-danger" id="errordescripcionAtributo" style="display: none;"></small>
                    </div>
                    <div class="form-group col-12">
                        <label for="message-text"
                            class="col-form-label">Precio:</label>
                        <input type="text" class="form-control" id="precio_ingrediente" placeholder="Precio de ingredientes">
                        <small class="text-danger" id="errorPrecio" style="display: none;"></small>
                    </div>
