                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <input type="hidden" id="idAtr" value="<?= $idAtrBase ?>">
      ...
      <!--Inicio modal editar-->
                                ...
                                <div class="modal fade" id="ModalEditar" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="nombreModal">Editar Atributo</h5>
                                                <input type="hidden" id="accionEdit">
                                                <input type="hidden" id="idAtr" value="<?= $idAtrBase ?>">
                                                <input type="hidden" id="estatusModal">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger"
                                                    data-dismiss="modal">Cancelar</button>
                                                <button type="button" class="btn btn-success" onclick="insertarEditar()">Actualizar</button>
                                                <!--<button type="button" class="btn btn-success" id="btnEnviar" onclick="insertarEditar()"></button>-->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger"
                                                    data-dismiss="modal">Cancelar</button>
                                                <button type="button" class="btn btn-success" id="btnModalBorrar_atributo" onclick="btnModalBorrar()">Borrar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
