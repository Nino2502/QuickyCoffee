                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top:10px;border-top:1px solid #e4e2e2">
                            <h3 style="color:#303030; font-size:18px; line-height: 1.6; font-weight:500;">SDI - cuenta registrada</h3>
                            <p style="color:#8f8f8f; font-size: 14px; padding-bottom: 20px; line-height: 1.4;">
                            ¡Felicidades! Tu cuenta ha sido creada con éxito. Ahora puedes disfrutar de todos nuestros servicios y funcionalidades. Gracias por unirte a nuestra comunidad.

                            <br>
                            <br>
                            Es importante recordar que la seguridad de tu cuenta es nuestra prioridad. Por eso, te recordamos que podrás cambiar y actualizar tu contraseña en cualquier momento dentro de nuestro sistema. De esta manera, podrás mantener tu cuenta segura y protegida en todo momento. ¡Gracias por confiar en nosotros!
                            </p>
                            <h3 style="color:#303030; font-size:18px; line-height: 1.6; font-weight:500;">Contraseña</h3>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="center" valign="middle" style="padding:13px;">
                                                            <a href="<?=base_url('login')?>"  target="_blank" style="font-size: 14px; line-height: 1.5; font-weight: 700; letter-spacing: 1px; padding: 15px 40px; text-align:center; text-decoration:none; color:#FFFFFF; border-radius: 50px; background-color:#145388;">Iniciar sesion</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
