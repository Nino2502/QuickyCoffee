                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body d-flex justify-content-between">
							...
							<div>
								...
								<a class="btn btn-primary"  href="<?= base_url()?>web">Regresar</a>
								<a class="btn btn-primary" href="<?= base_url()?>public/DetalleVenta/detalle/<?= $this->session->userdata('idusuario')?>/<?= $detalleVenta[0]->idVenta ?>/<?= $detalleVenta[0]->tokenVEnta ?>/" target="_blank">Imprimir</a>
								
								
								
								<a class="btn btn-primary" onclick="btnFacturar()" href="#" >Facturar</a>
							...
							<div>
								<label> * Selecciona RFC</label>
									<select  class="form-control select2-single" id="selectRFC">
										<option label="Elige" value="Selecciona">Elige uno</option>
										<option  value="sinRfc">Continuar sin RFC</option>
										
										
											<?php foreach($Fiscales as $Filafis): ?>
										
												<option value="<?= $Filafis->idFiscales?>" ><?= $Filafis->RFC?></option>
									...
									<small class="text-danger" id="errorselectRFC" style="display: none;"></small>
