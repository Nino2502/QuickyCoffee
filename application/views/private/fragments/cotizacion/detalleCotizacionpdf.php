...
<body>
    ...
    <table id="customers">
        ...
        <tr>
            <td style="text-align: center;" rowspan="3"><img style="width: 100; height: 70; text-align: center;" src="http://localhost/quicky_coffee/static/publico/img/sdi_logo.png"></td>
        </tr>
    ...
    <table style="text-align: center" id="customers">
        ...
        <td align="center"><img alt="Profile Picture" src="<?= "http://localhost/quicky_coffee/static/imgServicios/" . $item['image_url'] ?>" style="height: 20px;"/></td>
