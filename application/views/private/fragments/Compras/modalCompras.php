                                  ...
                                  <div class="modal fade" id="agreagaModal" tabindex="-1" role="dialog" aria-hidden="true">
...
<!-- Modal borrar -->
       ...
       <!--Inicio modal tipo de pago-->
                            ...
                            <!--<div class="modal fade " id="ModalAgregar"  tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <div class="modal fade" id="vistaPreviaModal" tabindex="-1" role="dialog" aria-hidden="false">
                                    ...
                                    <div class="modal-dialog" role="document">-->
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
												...
												<div class="row mb-3">
													<div class="col-6" id="datosCaptura">
													</div>
													<div class="col-6" id="datosCompra">
													</div>
												...
												<h5 class="card-title text-right" id="totalM"></h5>
												<h5 class="card-title text-right" id="ivaM"></h5>
												<h5 class="card-title text-right" id="totalMasIvaM"></h5>
...
<!-- Modal borrar -->
								...
								<div class="modal fade" id="vistaPreviaModalDos" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="tituloModaVistaPrevia"></h5>
