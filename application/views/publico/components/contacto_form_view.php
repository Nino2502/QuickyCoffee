...
<head>
    ...
    <meta name="description" content="SDI " />

    <meta name="keywords" content="Handy Hogar" />

    <meta name="author" content="Impactos Digitales" />

    <meta name="email" content="contacto_web@localhost/quicky_coffee" />

    <meta name="website" content="https://localhost/quicky_coffee" />
    ...
    <div style="margin-top: 50px;">
        ...
        <table cellpadding="0" cellspacing="0" style="font-family: Poppins, sans-serif; font-size: 15px; font-weight: 400; border: none; margin: 0 auto; border-radius: 6px; overflow: hidden; background-color: #fff; box-shadow: 0 0 3px rgba(60, 72, 88, 0.15);">
            ...
            <thead>
                ...
                <tr style="background-color: #0F3D64; padding: 3px 0; line-height: 68px; text-align: center; color: #fff; font-size: 24px; letter-spacing: 1px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <!--<td style="padding: 24px 24px 0; text-align: center">
                        ...
                        <img src="http://localhost/quicky_coffee/static/publico/img/sdi_logo.png" style="max-height: 400px !important;">
                ...
                <tr>
                    ...
                    <td>
						...
						<p style="text-align: center;">
                            ...
                            Contacto dede formulario web <br>
							<?= $fecha ?><br>
                        ...
                        <p style="text-align: left;">
							...
							<strong>El usuario:</strong> <?= $nombre ?><br>
							<strong>Con correo:</strong> <?= $correo ?><br>
							<strong>Envió el siguiente mensaje:</strong> <?= $mensaje ?><br>
