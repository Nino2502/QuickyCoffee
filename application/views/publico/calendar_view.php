...
<head>
	...
	<link rel="stylesheet" href="http://localhost/quicky_coffee/static/plantilla/font/iconsmind-s/css/iconsminds.css">
    <link rel="stylesheet" href="http://localhost/quicky_coffee/static/plantilla/font/simple-line-icons/css/simple-line-icons.css">
    
    <link rel="stylesheet" href="http://localhost/quicky_coffee/static/plantilla/css/vendor/bootstrap.min.css">
    <link rel="stylesheet" href="http://localhost/quicky_coffee/static/plantilla/css/vendor/bootstrap.rtl.only.min.css">
    <link rel="stylesheet" href="http://localhost/quicky_coffee/static/plantilla/css/vendor/perfect-scrollbar.css">
    <link rel="stylesheet" href="http://localhost/quicky_coffee/static/plantilla/css/vendor/component-custom-switch.min.css">
    <link rel="stylesheet" type="text/css" href="http://localhost/quicky_coffee/static/plantilla/css/dore.light.blue.min.css"><link rel="stylesheet" href="http://localhost/quicky_coffee/static/plantilla/css/main.css">
	<link rel="stylesheet" href="http://localhost/quicky_coffee/static/fontawesome-6.2.1-web/css/all.css">
    <link rel="stylesheet" href="http://localhost/quicky_coffee/static/toastr/toastr.min.css">

    <link rel="stylesheet" href="http://localhost/quicky_coffee/static/cssTables/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="http://localhost/quicky_coffee/static/cssTables/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css">
 <link rel="stylesheet" href="http://localhost/quicky_coffee/static/plantilla/css/vendor/select2.min.css">
                <link rel="stylesheet" href="http://localhost/quicky_coffee/static/plantilla/css/vendor/select2-bootstrap.min.css">
                <link rel="stylesheet" href="http://localhost/quicky_coffee/static/plantilla/css/vendor/bootstrap-datepicker3.min.css">
...
<body>
	...
	<!-- Listado de scripts-->
	            ...
	            <script type="text/javascript" src="http://localhost/quicky_coffee/static/plantilla/js/dore-plugins/select.from.library.js" style="opacity: 1;"></script>
                <script type="text/javascript" src="http://localhost/quicky_coffee/static/plantilla/js/vendor/select2.full.js" style="opacity: 1;"></script>
                <script type="text/javascript" src="http://localhost/quicky_coffee/static/propiosScripts/GastoVariado.js" style="opacity: 1;"></script>
                <script type="text/javascript" src="http://localhost/quicky_coffee/static/propiosScripts/tabla/datatables.net/js/jquery.dataTables.min.js" style="opacity: 1;"></script>
                <script type="text/javascript" src="http://localhost/quicky_coffee/static/propiosScripts/tabla/datatables.net-bs4/js/dataTables.bootstrap4.min.js" style="opacity: 1;"></script>
                <script type="text/javascript" src="http://localhost/quicky_coffee/static/propiosScripts/tabla/datatables.net-responsive/js/dataTables.responsive.min.js" style="opacity: 1;"></script>
                <script type="text/javascript" src="http://localhost/quicky_coffee/static/propiosScripts/tabla/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js" style="opacity: 1;"></script>
                <script type="text/javascript" src="http://localhost/quicky_coffee/static/propiosScripts/tabla/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js" style="opacity: 1;"></script>
                <script type="text/javascript" src="http://localhost/quicky_coffee/static/plantilla/js/vendor/bootstrap-datepicker.js" style="opacity: 1;"></script>
