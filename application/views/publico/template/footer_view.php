					...
					<div class="collapse dont-collapse-sm" id="collapse_4">
						...
						<div class="follow_us">
							...
							<ul>
								...
								<li><a href="#0"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="<?= base_url()."static/plantilla/frontImg/"?>facebook_icon.svg" alt="" class="lazy"></a></li>
			...
			<div class="row add_bottom_25">
				...
				<div class="col-lg-6">
					<ul class="additional_links">
						...
						<li><a href="#0">Politica de privacidad</a></li>
